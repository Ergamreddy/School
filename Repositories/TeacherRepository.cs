...
public class TeacherRepository : BaseRepository, ITeacherRepository
{
    ...
    {
        var query = $@"INSERT INTO ""{TableNames.teacher}"" (name, surname, mobile, subject_id) 
       VALUES (@Name, @Surname, @Mobile, @SubjectId)
       RETURNING *";
    ...
    {
        var query = $@"UPDATE ""{TableNames.teacher}"" SET surname = @Surname, 
